...
function formatSearchResultItem(item,terms){return'<div id="search-results-item" class="'+getResultSection(item)+'">'
+'<a href="'+item.ref+'">'
...
var options={bool:'AND',fields:{title:{boost:2},body:{boost:1},},expand:true,}
var currentTerm=''
