...
const getActionFigureSentence=()=>{const sentences=[`"This 'Gorgobot' figure from 1972 is pretty neat, it has telescopic arms and an inflatable chest piece!"`,`"I have this Kaboozle Toys 'Discombobulon' figure from the desert death match scenes that was never actually released."`,`"Yeah, the 'Konglomatron 2000' is pretty priceless, but then again, I’d never sell it so who cares, right?"`,`"All of these babies are pretty much priceless, but my personal favorite is this 'Rash Man' figure, it’s a beaut!"`,`"Yeah," he starts, then looses the thread and trails off into an adjacent room.`,`"If I had to pick one, I’d say this 'The French Tickler' figure is, ahem, 'le pièce de résistance' of my collection, as it were."`,]
...
**Lenny** is here, carefully dusting a collection of action figures housed in a display **cabinet** to the left of the counter.`,exits:[{dir:['west','Ascii Arena','Text Games'],id:'text-games'},{dir:['east','Pixel Paradise','Graphical Games'],id:'graphical-games'},],items:[{name:['crate','discount crate','discounted games'],desc:'Ths discount crate is empty at the moment.'},{name:['cabinet','display cabinet','action figures'],desc:`You lean over and inspect the display cabinet. There are some real gems in there.
"No touchy-touchy," Lenny says. "Only looky-looky."`,},],},{name:'The Ascii Arena',id:'text-games',desc:`There is a huge banner covering the entire west wall of the room. It reads:
...
Theres a **note** pinned to the banner. The **shelves** are remarkably empty. An opening in the **east** wall leads back to the front room.`,onLook:()=>{println('You’re standing in the Ascii Arena, as Lenny somewhat hyperbolically has christened this tiny room holding all his text-based adventure games.')},items:[{name:['shelves','games'],desc:`There are a few games lining the shelves, but most of them have giant stickers saying "PRIVATE COLLECTION! NOT FOR SALE, RENT OR USE." The only available games are:
...
A door to the **west** leads back to the main room.`,exits:[{dir:'west',id:'lennys'},],items:window.games.filter((game)=>game.extra&&game.extra.room==='graphical-games').map((game)=>({name:[game.title]}))},],characters:[{name:['Lenny'],roomId:'lennys',desc:'Lenny doesn’t look anything at all like you’d picture a purveyor of retro games and action figures. In fact, judging by his jawline alone, you’d have him pegged as a personal trainer for the elderly or a retired police officer. But his tight, sleeveless t-shirt says "I got the Babel Fish", and on his left wrist is a Casio C-80 calculator watch.',topics:[{option:'Compliment Lenny’s display **cabinet**',keyword:'cabinet',removeOnRead:false,line:()=>`"Wow, Lenny. That’s some hero collection you’ve got there," you say. Lenny looks up, self-assured. You continue. "Any priceless ones?"
"Well..." Lenny scratches his stubble. ${getActionFigureSentence()}`,},...window.games.map((game)=>{const shortName=getShortName(game.title)
