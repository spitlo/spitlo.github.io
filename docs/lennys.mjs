...
**Lenny** is here, carefully dusting a collection of action figures housed in a display **cabinet** to the left of the counter.`,exits:[{dir:['west','Ascii Arena','Text Games'],id:'text-games'},{dir:['east','Pixel Paradise','Graphical Games'],id:'graphical-games'},{dir:['south','out','exit','home'],id:'exit'},],items:[{name:['crate','discount crate','discounted games'],desc:'Ths discount crate is empty at the moment.'},{name:['cabinet','display cabinet','action figures'],desc:`You lean over and inspect the display cabinet. There are some real gems in there.
"No touchy-touchy," Lenny says and wags his finger. "Only looky-looky."`,},],},{name:'The Ascii Arena',id:'text-games',desc:`There is a huge banner covering the entire west wall of the room. It reads:
