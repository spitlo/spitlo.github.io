...
const carExit=getExit('car',bedroom.exits)
carExit.block='The oxygen tank is leaking and your father is dying from asphyxiation. Is now really the time to leave?'}else{decreaseTimer(1)
...
You’re not off to a good start. It’s apparent you’ll need `,keyword:'oxygen',removeOnRead:true,onSelected:()=>decreaseTimer(1),},{option:'Ask to speak to an **administrator**',line:`"I want to speak to an administrator," you say sternly.

René shuffles a few papers, restarts a lucky cat whose arm is slowing down somewhat, and picks up his phone again.

"The administrator is busy," he mumbles.`,keyword:'administrator',prereqs:['oxygen'],removeOnRead:true,onSelected:()=>decreaseTimer(2),},{option:'**Insist** on speaking to an administrator',line:`"Put down your phone and look at me," you say in your most decisive tone.
...
Then you add, "He is dying."`,keyword:'beg',prereqs:['insist'],removeOnRead:true,onSelected:()=>decreaseTimer(4),},{option:'**Demand** to speak to a god damned administrator',line:`You bang your fist in the desk. "Call up a god damned administrator," you scream. "I’m not asking!"
